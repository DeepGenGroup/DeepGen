...
MLIR_DIR=/home/xushilong/rocmllvm18/llvm-project/build/lib/cmake/mlir
LLVM_BUILD=/home/xushilong/rocmllvm18/llvm-project/build/
...
if [ -n "$1" ]; then
  ...
  cmake .. -GNinja \
    ...
    -DTRITON_CODEGEN_BACKENDS="nvidia;amd" \
    -DMLIR_DIR=/home/xushilong/rocmllvm18/llvm-project/build/lib/cmake/mlir
else
  cd ${BUILD}
fi
