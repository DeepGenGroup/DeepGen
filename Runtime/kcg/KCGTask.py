...
class ParallelTaskManager :
    ...
    #     arg.BLOCK_LAYOUT_M = config[kw.KEY_BLOCK_LAYOUT_Y]
    #     arg.BLOCK_LAYOUT_N = config[kw.KEY_BLOCK_LAYOUT_X]
    #     arg.WARP_LAYOUT_M = config[kw.KEY_WARP_LAYOUT_Y]
    #     arg.WARP_LAYOUT_N = config[kw.KEY_WARP_LAYOUT_X]
    ...
    #     arg.WARP_SCATTER_WIDTH_A = config[kw.KEY_BLOCK_SCATTER_WIDTH_M]
    #     arg.WARP_SCATTER_WIDTH_B = config[kw.KEY_BLOCK_SCATTER_WIDTH_N]
    #     arg.THREAD_SCATTER_WIDTH_A = config[kw.KEY_WARP_SCATTER_WIDTH_M]
    #     arg.THREAD_SCATTER_WIDTH_B = config[kw.KEY_WARP_SCATTER_WIDTH_N]
    ...
    #     arg.REDUCE_C_CONTINUOUS = config[kw.KEY_STORE_CONTINUOUS]
    #     return arg
