...
class ModelArgs:
    ...
    vocab_size: int = 8192  # defined later by tokenizer
...
def compile_model( model, args : ModelArgs, devId : int) :
    ...
    for (Ty , args ) in OpProxy.GetCollectedKernelArgs() :
        ...
        kernel_compile_tuning(Ty,'/home/xushilong/DeepGen/TuningConfigs/GEMM_cfg_32.json',devId,ts)
