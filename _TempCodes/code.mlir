    ...
    affine.parallel (%arg4, %arg5, %arg6) = (0, 0, 0) to (2, 1, 1) {
      ...
      affine.parallel (%arg7) = (0) to (256) {
        ...
        affine.for %arg8 = 0 to 128 step 64 {
          ...
          %alloca_8 = memref.alloca() {alignment = 16 : i64, kcg.bufDesc = "regMax"} : memref<2xf32>
          %alloca_9 = memref.alloca() {alignment = 16 : i64, kcg.bufDesc = "regSum"} : memref<2xf32>
          affine.for %arg9 = 0 to 2 {
            %cst = arith.constant 0xFF800000 : f32
            affine.store %cst, %alloca_8[%arg9] : memref<2xf32>
            %cst_18 = arith.constant 0.000000e+00 : f32
            affine.store %cst_18, %alloca_9[%arg9] : memref<2xf32>
          } {for.desc = "initBuf"}
          ...
          affine.for %arg9 = 0 to 2 {
            affine.for %arg10 = 0 to 8 {
              %1 = affine.load %alloca_17[%arg9, %arg10] : memref<2x8xf32>
              %2 = affine.load %alloca_8[%arg9] : memref<2xf32>
              %3 = affine.load %alloca_9[%arg9] : memref<2xf32>
              ...
              affine.store %4, %alloca_8[%arg9] : memref<2xf32>
              affine.store %10, %alloca_9[%arg9] : memref<2xf32>
            } {for.desc = "ttilexDown"}
          } {for.desc = "ttileyDown"}
          affine.for %arg9 = 0 to 2 {
            %c8_i32 = arith.constant 8 : i32
            %c1_i32 = arith.constant 1 : i32
            %1 = affine.load %alloca_8[%arg9] : memref<2xf32>
            %shuffleResult, %valid = gpu.shuffle  down %1, %c1_i32, %c8_i32 : f32
            %2 = affine.load %alloca_9[%arg9] : memref<2xf32>
            %shuffleResult_18, %valid_19 = gpu.shuffle  down %2, %c1_i32, %c8_i32 : f32
            ...
            affine.store %3, %alloca_8[%arg9] : memref<2xf32>
            affine.store %10, %alloca_9[%arg9] : memref<2xf32>
            %c2_i32 = arith.constant 2 : i32
            %11 = affine.load %alloca_8[%arg9] : memref<2xf32>
            %shuffleResult_20, %valid_21 = gpu.shuffle  down %11, %c2_i32, %c8_i32 : f32
            %12 = affine.load %alloca_9[%arg9] : memref<2xf32>
            %shuffleResult_22, %valid_23 = gpu.shuffle  down %12, %c2_i32, %c8_i32 : f32
            ...
            affine.store %13, %alloca_8[%arg9] : memref<2xf32>
            affine.store %20, %alloca_9[%arg9] : memref<2xf32>
            %c4_i32 = arith.constant 4 : i32
            %21 = affine.load %alloca_8[%arg9] : memref<2xf32>
            %shuffleResult_24, %valid_25 = gpu.shuffle  down %21, %c4_i32, %c8_i32 : f32
            %22 = affine.load %alloca_9[%arg9] : memref<2xf32>
            %shuffleResult_26, %valid_27 = gpu.shuffle  down %22, %c4_i32, %c8_i32 : f32
            ...
            affine.store %23, %alloca_8[%arg9] : memref<2xf32>
          ...
          affine.for %arg9 = 0 to 2 {
            ...
            %shuffleResult, %valid = gpu.shuffle  idx %1, %c0_i32, %c8_i32 : f32
            affine.store %shuffleResult, %alloca_8[%arg9] : memref<2xf32>
          }
          affine.for %arg9 = 0 to 2 {
            affine.for %arg10 = 0 to 8 {
              %1 = affine.load %alloca_17[%arg9, %arg10] : memref<2x8xf32>
          ...
          affine.for %arg9 = 0 to 64 step 16 {
            gpu.barrier
            affine.for %arg10 = 0 to 2 {
              %1 = affine.vector_load %arg2[%arg6, %arg5, %arg8 + %arg9 + %arg10 * 8 + (%arg7 * 4) floordiv 128, (%arg7 * 4) mod 128] : memref<1x1x128x128xf32, 1>, vector<4xf32>
              ...
              affine.for %arg11 = 0 to 2 {
                affine.for %arg12 = 0 to 1 {
                  affine.for %arg13 = 0 to 1 {
                    ...
                    affine.vector_store %1, %arg3[%arg6, %arg5, %0 + (%arg8 * 2 + ((%arg7 floordiv 32) floordiv 4) * 2) * 8 + %arg10 * 8 + (%arg7 mod 32) floordiv 4 + %arg12, (%arg9 * 4 + ((%arg7 floordiv 32) mod 4) * 2) * 4 + %arg11 * 4 + %arg7 mod 4 + %arg13] : memref<1x1x128x128xf32, 1>, vector<1xf32>
                  }
                }
              }
            }
