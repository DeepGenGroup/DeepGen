        ...
        affine.for %bx = 0 to 128 step 64 {
          ...
          affine.for %arg9 = 0 to 4 {
            affine.for %arg10 = 0 to 4 {
              ...
              // %4 = arith.maxnumf %2, %1 : f32  // max{tileP, regMax}
              // %5 = arith.subf %2, %4 : f32  // regMax - max{tileP, regMax}
              // %6 = math.exp %5 : f32  // exp(regMax - max{tileP, regMax}) , init = exp(-inf) = 0
              ...
              // // affine.store %9, %regSum[%arg9] : memref<4xf32>  0
              affine.store %1, %regSum[%arg9] : memref<4xf32>
          ...
          affine.for %arg9 = 0 to 4 {
            ...
            // // debug
            affine.store %2, %regSum[%arg9] : memref<4xf32>
          ...
          affine.if affine_set<(d0) : (d0 mod 16 == 0)>(%tid) {
            affine.for %arg9 = 0 to 4 {
              ...
              // debug :
              affine.store %4, %smSum[(%tid floordiv 64) * 16 + ((%tid mod 64) floordiv 16) * 4 + %arg9] : memref<32xf32, 3>
        ...
        affine.for %bx = 0 to 128 step 64 {
          ...
          affine.for %arg9 = 0 to 4 {
            affine.for %arg10 = 0 to 4 {
              ...
              // affine.store %6, %tileP[%arg9, %arg10] : memref<4x4xf32>
              affine.store %5, %tileP[%arg9, %arg10] : memref<4x4xf32>
