module {
  func.func public @kcg_Attention_1_32_4096_128_Br32Bc64Hd128_Sa16Sb8PTr4PTc4OTr4OTc8GLWQ4GLWK4GLWV4BLPY4BLPX1WLPY2WLPX16BSWQ4BSWK2WSWQ1WSWK1BLOY1BLOX4WLOY8WLOX4BSWP4BSWV2WSWP1WSWV1Un16W32LCP1LCO1SPP0RPP0RPO0(%arg0: memref<1x32x128x4096xf32, 1>, %arg1: memref<1x32x128x4096xf32, 1>, %arg2: memref<1x32x4096x128xf32, 1>, %arg3: memref<1x32x4096x128xf32, 1>) attributes {arg.tran = [true, false, false], func.op.type = "FlashAttn", func.output.arg.num = 1 : i32, func.state = "gpu", parallel.dim = ["y"]} {
    affine.parallel (%arg4, %arg5, %arg6) = (0, 0, 0) to (128, 32, 1) {
      ...
      affine.parallel (%arg7) = (0) to (128) {
        ...
        affine.for %arg8 = 0 to 4096 step 64 {
          ...
          affine.for %arg9 = 0 to 128 step 16 {
            ...
            affine.for %arg10 = 0 to 1 {
              %1 = affine.vector_load %arg0[%arg6, %arg5, %arg9 + %arg10 * 16 + (%arg7 * 4) floordiv 32, %0 + (%arg7 * 4) mod 32] : memref<1x32x128x4096xf32, 1>, vector<4xf32>
            ...
            affine.for %arg10 = 0 to 2 {
              %1 = affine.vector_load %arg1[%arg6, %arg5, %arg9 + %arg10 * 8 + (%arg7 * 4) floordiv 64, %arg8 + (%arg7 * 4) mod 64] : memref<1x32x128x4096xf32, 1>, vector<4xf32>
            ...
            affine.for %arg10 = 0 to 16 {
              affine.for %arg11 = 0 to 1 {
                affine.for %arg12 = 0 to 4 {
                  %1 = affine.vector_load %alloc[%arg10, (%arg11 * 4 + %arg7 floordiv 32) * 8 + %arg12 * 2 + (%arg7 mod 32) floordiv 16] : memref<16x32xf32, 3>, vector<1xf32>
                  affine.vector_store %1, %alloca_13[%arg11 * 4 + %arg12] : memref<4xf32>, vector<1xf32>
                } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
              } {affine.loop = "unroll", affine.unroll.num = 16 : i32, for.desc = ""}
          ...
          affine.if affine_set<(d0) : (d0 mod 16 == 0)>(%arg7) {
            affine.for %arg9 = 0 to 4 step 4 {
              affine.for %arg10 = 0 to 4 {
                affine.for %arg11 = 0 to 1 {
                  %1 = affine.load %alloc_4[(%arg9 * 4 + (%arg7 floordiv 32) * 4) * 2 + %arg10 * 2 + (%arg7 mod 32) floordiv 16 + %arg11] : memref<32xf32, 3>
                  %2 = affine.load %alloca_8[%arg9 + %arg10 + %arg11] : memref<4xf32>
                  %3 = affine.load %alloc_5[(%arg9 * 4 + (%arg7 floordiv 32) * 4) * 2 + %arg10 * 2 + (%arg7 mod 32) floordiv 16 + %arg11] : memref<32xf32, 3>
                  ...
                  affine.store %5, %alloc_4[(%arg9 * 4 + (%arg7 floordiv 32) * 4) * 2 + %arg10 * 2 + (%arg7 mod 32) floordiv 16 + %arg11] : memref<32xf32, 3>
                  affine.store %12, %alloc_5[(%arg9 * 4 + (%arg7 floordiv 32) * 4) * 2 + %arg10 * 2 + (%arg7 mod 32) floordiv 16 + %arg11] : memref<32xf32, 3>
                  affine.store %9, %alloc_3[(%arg9 * 4 + (%arg7 floordiv 32) * 4) * 2 + %arg10 * 2 + (%arg7 mod 32) floordiv 16 + %arg11] : memref<32xf32, 3>
                ...
                affine.for %arg12 = 0 to 2 {
                  affine.for %arg13 = 0 to 1 {
                    affine.for %arg14 = 0 to 1 {
                      ...
                      affine.vector_store %1, %alloc_2[(%arg9 * 4 + (%arg7 floordiv 32) * 4) * 2 + %arg11 * 2 + (%arg7 mod 32) floordiv 16 + %arg13, %arg10 * 16 + %arg12 * 16 + %arg7 mod 16 + %arg14] : memref<32x64xf32, 3>, vector<1xf32>
                    } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
                  } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
                } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
              } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
          ...
          affine.for %arg9 = 0 to 1 {
            affine.for %arg10 = 0 to 4 {
              %1 = affine.vector_load %alloc_3[(%arg9 + (%arg7 floordiv 32) floordiv 4) * 32 + %arg10 * 8 + (%arg7 mod 32) floordiv 4] : memref<32xf32, 3>, vector<1xf32>
              affine.vector_store %1, %alloca_7[%arg9 * 4 + %arg10] : memref<4xf32>, vector<1xf32>
            } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
          } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
          affine.for %arg9 = 0 to 4 {
          ...
          affine.for %arg9 = 0 to 64 step 8 {
            gpu.barrier
            affine.for %arg10 = 0 to 2 {
              %1 = affine.vector_load %arg2[%arg6, %arg5, %arg8 + %arg9 + %arg10 * 4 + (%arg7 * 4) floordiv 128, (%arg7 * 4) mod 128] : memref<1x32x4096x128xf32, 1>, vector<4xf32>
            ...
            affine.for %arg10 = 0 to 8 {
              affine.for %arg11 = 0 to 1 {
                affine.for %arg12 = 0 to 4 {
                  affine.for %arg13 = 0 to 1 {
                    %1 = affine.vector_load %alloc_2[(%arg11 + (%arg7 floordiv 32) floordiv 4) * 32 + %arg12 * 8 + (%arg7 mod 32) floordiv 4 + %arg13, %arg9 + %arg10] : memref<32x64xf32, 3>, vector<1xf32>
                    affine.vector_store %1, %alloca_15[%arg11 * 4 + %arg12 + %arg13] : memref<4xf32>, vector<1xf32>
                  } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
                } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
              } {affine.loop = "unroll", affine.unroll.num = 16 : i32, for.desc = ""}
              affine.for %arg11 = 0 to 4 {
                affine.for %arg12 = 0 to 2 {
                  %1 = affine.vector_load %alloc_1[%arg10, (%arg11 * 4 + (%arg7 floordiv 32) mod 4) * 8 + %arg12 * 4 + %arg7 mod 4] : memref<8x128xf32, 3>, vector<1xf32>
        ...
        affine.for %arg8 = 0 to 1 {
          affine.for %arg9 = 0 to 4 {
            %1 = affine.vector_load %alloc_5[(%arg8 + (%arg7 floordiv 32) floordiv 4) * 32 + %arg9 * 8 + (%arg7 mod 32) floordiv 4] : memref<32xf32, 3>, vector<1xf32>
            affine.vector_store %1, %alloca[%arg8 * 4 + %arg9] : memref<4xf32>, vector<1xf32>
          } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
        } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
        affine.for %arg8 = 0 to 4 {
          affine.for %arg9 = 0 to 8 {
              ...
              affine.for %arg11 = 0 to 2 {
                affine.for %arg12 = 0 to 1 {
                  affine.for %arg13 = 0 to 1 {
                    ...
                    affine.vector_store %1, %arg3[%arg6, %arg5, %0 + (%arg8 + ((%arg7 floordiv 32) floordiv 4) * 4) * 8 + %arg10 * 8 + (%arg7 mod 32) floordiv 4 + %arg12, (%arg9 * 4 + ((%arg7 floordiv 32) mod 4) * 2) * 4 + %arg11 * 4 + %arg7 mod 4 + %arg13] : memref<1x32x4096x128xf32, 1>, vector<1xf32>
                  } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
                } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
              } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
            } {affine.loop = "unroll", affine.unroll.num = 16 : i32}
