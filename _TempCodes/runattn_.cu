...
int main(int argc, char* argv[]) {
  ...
  // 获取内核函数句柄
  CUfunction kernel;
  result = cuModuleGetFunction(&kernel, module, "kcg_Attention_1_32_2048_128_Br32Bc64Hd128_Sa16Sb8PTr4PTc4OTr4OTc8GLWQ4GLWK4GLWV4BLPY4BLPX1WLPY2WLPX16BSWQ4BSWK2WSWQ4WSWK2BLOY2BLOX2WLOY4WLOX8BSWP4BSWV4WSWP4WSWV4Un8W32LCP1LCO1SPP0RPP0RPO0");
  if (result != CUDA_SUCCESS) {
  ...
  cuLaunchKernel(kernel, 64, 32, 1, 128, 1, 1, 18816, 0, args, NULL);
