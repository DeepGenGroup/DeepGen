module {
  func.func public @reduce(%arg0: memref<32x16xf32, 1>, %arg1: memref<32x16xf32, 1>) {
    affine.parallel (%arg2) = (0) to (16) {
      affine.parallel (%arg3) = (0) to (32) {
        %0 = affine.load %arg0[%arg2 + (%arg3 floordiv 16) * 16, %arg3 mod 16] : memref<32x16xf32, 1>
        ...
        // %c16_i32 = arith.constant 16 : i32
        // %shuffleResult_4, %valid_4 = gpu.shuffle  down %4, %c16_i32, %c16_i32 : f32
        // %5 = arith.addf %4, %shuffleResult_4 : f32

        affine.store %4, %arg1[%arg2 + (%arg3 floordiv 16) * 16, %arg3 mod 16] : memref<32x16xf32, 1>
      } {gpu.index = "threadIdx"}
    } {gpu.index = "blockIdx"}
    return
  }
