...
date
${PYTHON_BIN} SimpleLocalTester.py ${CFG} ./testattn_gemma2_k1_${SEQLEN}.json 0 10 0 0 gemma2_k1 ${DEV} ${DTYPE} --seqlen "$SEQLEN"

echo ""
echo "=== [2/3] Tuning K2 (FlashAttnSplitK2 + softcap) ==="
date
${PYTHON_BIN} SimpleLocalTester.py ${CFG} ./testattn_gemma2_k2_${SEQLEN}.json 0 10 0 0 gemma2_k2 ${DEV} ${DTYPE} --seqlen "$SEQLEN"
