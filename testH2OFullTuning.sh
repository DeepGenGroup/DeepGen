...
date
python SimpleLocalTester.py ${CFG} ./testattn_h2o_k1.json 0 0 0 0 h2o_k1 ${DEV} ${DTYPE} --seqlen "$SEQLEN"

echo ""
echo "=== [2/4] Tuning K2 (GemmNormColSum) ==="
date
python SimpleLocalTester.py ${CFG} ./testattn_h2o_k2.json 0 0 0 0 h2o_k2 ${DEV} ${DTYPE} --seqlen "$SEQLEN"

echo ""
echo "=== [3/4] Tuning K3 (FlashAttnSplitK2) ==="
date
python SimpleLocalTester.py ${CFG} ./testattn_h2o_k3.json 0 0 0 0 h2o_k3 ${DEV} ${DTYPE} --seqlen "$SEQLEN"
