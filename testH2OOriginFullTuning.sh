...
CFG=${CFG:-${PROJECT_DIR}/TuningConfigs/h2o_split.json}
...
echo "=============================================="
echo " H2O Origin Full Tuning - Device ${DEV}, dtype ${DTYPE}, seqlen ${SEQLEN}"
echo " Config: ${CFG}"
echo "=============================================="
...
echo ""
echo "=============================================="
echo " H2O Origin Full Tuning Complete"
echo " Results: testattn_h2o_origin_${SEQLEN}.json"
echo "=============================================="
date
