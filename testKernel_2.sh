...
# cfg=/home/xushilong/DeepGen/TuningConfigs/mmTest/mm-2048-2048-2048.json
cfg=/home/xushilong/DeepGen/TuningConfigs/xbk/gemm.json
st=0
max=0
...
python SimpleLocalTester.py $cfg ./xbk_single_gemm2048_${SEQLEN}.json 0 $max 0 0 matmul 4 float32 --seqlen 2048
