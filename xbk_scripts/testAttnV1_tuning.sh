...
python SimpleLocalTester.py /home/xushilong/DeepGen/TuningConfigs/attn_llama2_0227.json ./xbk_testattn_naive.json 0 0 0 0 attn_v1 3 --seqlen "$SEQLEN" float32 tune